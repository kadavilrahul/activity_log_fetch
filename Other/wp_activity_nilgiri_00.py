...
DATABASE_NAME = os.getenv("DATABASE_NAME_2")
DATABASE_USER = os.getenv("DATABASE_USER_2")
DATABASE_PASSWORD = os.getenv("DATABASE_PASSWORD_2")
...
def main():
    ...
    parser.add_argument('--prefix', type=str, default='kdf_', help='Database table prefix (default: kdf_)')
