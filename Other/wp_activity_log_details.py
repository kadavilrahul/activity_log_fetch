...
EVENT_DESCRIPTIONS = {
    ...
    1002: "Login failed",
    1003: "Login failed (unknown username)",
    1004: "Login blocked",
    2001: "Post created",
    2002: "Post published",
    2008: "Post permanently deleted",
    2010: "Post moved to trash",
    2021: "Page created",
    2022: "Page published",
    2028: "Page permanently deleted",
    2030: "Page moved to trash",
    4000: "User created",
    4001: "User deleted",
    4002: "User profile modified",
    4003: "User role changed",
    5000: "User logged in to WordPress admin",
    5001: "User logged out from WordPress admin",
    6000: "Plugin activated",
    6001: "Plugin deactivated",
    6002: "Plugin installed",
    6003: "Plugin upgraded",
    6004: "Plugin deleted",
    7000: "Theme activated",
    7001: "Theme installed",
    7002: "Theme updated",
    9000: "WordPress updated",
    9001: "WordPress update available"
}
...
def extract_metadata(occurrence_id, cursor):
    ...
    try:
        ...
        cursor.execute("SELECT COUNT(*) as metadata_count FROM wp_wsal_metadata WHERE occurrence_id = %s", (occurrence_id,))
...
def main():
    ...
    parser.add_argument('--limit', type=int, default=100, help='Number of records to retrieve (default: 100)')
    parser.add_argument('--days', type=int, help='Show events from the last X days')
    parser.add_argument('--event', type=int, help='Filter by specific event ID')
    ...
    try:
        ...
        if connection.is_connected():
            ...
            if args.diagnose:
                diagnose_wsal_tables(cursor)
                return
            
            # Get available columns in the occurrences table
            occurrence_columns = get_table_columns(cursor, 'wp_wsal_occurrences')
            ...
            for record in records:
                ...
                metadata = {}
                try:
                    metadata = extract_metadata(occurrence_id, cursor)
